...
document.getElementById('city').innerHTML="You have "+building+ " buildings in your city";
...
//shortcut to add one to variable
building++;
document.getElementById('city').innerHTML="You have "+building+ " building in your city";
